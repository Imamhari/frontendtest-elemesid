  ...
  return (
    <section className="flex justify-between items-center p-6 bg-transparent mx-20 w-[1440px] h-[653px]">
      ...
      <div className="w-[482px] h-[286.92px] top-[182.49px] left-[120px] flex flex-col gap-[32px]">
        <h2 className="font-medium text-[64px] leading-[64px] tracking-[0%] text-[#8BAC3E]">Good Food Us Good Mood</h2>
        ...
        <div className='flex gap-5'>
          <button className='bg-[#8BAC3E] shadow-[0px_8px_32px_0px_#666BE259] text-white rounded-full w-[147px] h-[42px]'>Daftar Sekarang</button>
